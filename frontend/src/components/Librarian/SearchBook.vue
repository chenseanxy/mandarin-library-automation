...
export default {
    ...
    methods: {
        getBookList() {
            ...
            this.booklist = [
                {"bookname":"大雪中的山庄","author":"东野圭吾","publisher":"北京十月文艺出版社","isbn":"9787530216835","status":"在馆"},
                {"bookname":"三生三世 十里桃花","author":"唐七公子","publisher":"沈阳出版社","isbn":"9787544138000","status":"在馆"},
                {"bookname":"何以笙箫默","author":"顾漫","publisher":"朝华出版社","isbn":"9787505414709","status":"遗失"},
                {"bookname":"人类简史","author":"[以色列] 尤瓦尔·赫拉利","publisher":"中信出版社","isbn":"9787508647357","status":"在馆"},
                {"bookname":"明朝那些事儿","author":"当年明月","publisher":"中国海关出版社","isbn":"9787801656087","status":"已借出"}
                ];
            this.total = 5;
        },
        judgeType(status){
