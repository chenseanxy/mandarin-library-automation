    ...
    <div class="block">
      ...
      <div class="info_box">
        ...
        <el-row :gutter="5">
          ...
          <el-col :span="12">
            <p class="count-fine">$ {{fineValue}} /day</p>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="5">
          ...
          <el-col :span="12">
            <p class="count-returnPeriod">{{returnPeriod}} days</p>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="5">
          ...
          <el-col :span="12">
            <p class="count-depoist">$ {{depoist}}</p>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="3" class="btns">
          ...
          <el-col :span="6">
            <el-button type="primary" icon="el-icon-edit" size="big" @click="edit">Edit </el-button>
          </el-col>
          <el-col :span="10">
            <el-button type="danger" icon="el-icon-close" size="big" @click="cancel">Cancel</el-button>
          </el-col>
        </el-row>
